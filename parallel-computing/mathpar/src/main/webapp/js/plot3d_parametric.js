define([
   ...
   * @constructor
   */
  var Plot3dParametric = function (sectionId, $imageBelow) {
    'use strict';
    ...
    $.ajax({
      url: util.url('/api/plot3dparametric'),
      type: 'POST',
  ...
  Plot3dParametric.prototype.animate = function () {
    var this_ = this;
  ...
  Plot3dParametric.prototype.update = function () {
  ...
  Plot3dParametric.prototype.render = function () {
    this.renderer.render(this.scene, this.camera);
  };

  return Plot3dParametric;
});
