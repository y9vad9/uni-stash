...
//           
                ...
                MPITransport.bcastObjectArray(t,t.length, 0);
                 ...
                 System.out.println(rank+": making MatrixD  needs "+(mem3-mem2)+" bytes");
                ...
                int[] mod_count = ch.complexityNumberZMatrix(r);
...
//              
    //Разбиение полинома
                ...
                Object recv_parts[] = new Object[gen_mod_count*mpiSize];
...
//                MPI.COMM_WORLD.bcast(t, ti[0], MPI.BYTE, 0);
                ...
                MPITransport.bcastObjectArray(resv_etalon, numParts, 0);
     ...
     public static Polynom[] eachProcCalcModules(int[] data,
        ...
        charPolynomMatrixD ch = new charPolynomMatrixD();
         for (int k = 0; k < counts; k++) {
            ...
            res[k] = Polynom.polynomFromNumber(NumberZ.ONE, r);//new Polynom(new int[]{0}, new NumberZp32[]{NumberZp32.ONE});
