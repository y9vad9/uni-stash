...
//                                    System.out.println();
                ...
                for (int number = 0; number < nnum; number++) {//по числ модулям
                    ...
                    /*
                     * 0:
                     * -71656z^2y^2x^2+1998580449z^2yx^2-1998470893z^2x^2-32771zy^2x^2-390zyx^3-12272zyx^2-727zx^3+1998559649zx^2+44221y^2x^2-572yx^3+1998566509yx^2+x^4-317x^3-76988x^2
                     * 0:
                     * -71656z^2y^2x^2+1978657505z^2yx^2-1978547949z^2x^2-32771zy^2x^2-390zyx^3-12272zyx^2-727zx^3+1978636705zx^2+44221y^2x^2-572yx^3+1978643565yx^2+x^4-317x^3-76988x^2
                     */

                    //в полиномах из массива result
                    //x - переменная, по которой записывается характеристический полином,
                    //y, z,... -- это переменные, которые в данной матрице были x, y,... соответственно

                }

                // System.out.println(rank+ " after recoveryOfLin");
                ...
                //System.out.println(j+": "+data[0][j]);//+"   "+result[j].toString());

                //}
                //System.out.println("mod.l= "+data[0].length+", rem.l= "+result.length);
                ring.MOD32 = Integer.MAX_VALUE;
                Polynom charpol = Newton.recoveryNewtonPolynom(data[0], result, ring);
                ...
                int narr[] = new int[data[0].length];
                System.arraycopy(data[0], 0, narr, 0, data[0].length);
...
//                Object[] resv_etalon = new Object[mpiSize];
//                //процедура обратная для Serialize
//                MPI.COMM_WORLD.Object_Deserialize(resv_etalon, t, 0, mpiSize, MPI.OBJECT);               
//                Polynom[] etalon_parts = new Polynom[mpiSize];
//                for (int i = 0; i < mpiSize; i++) {
