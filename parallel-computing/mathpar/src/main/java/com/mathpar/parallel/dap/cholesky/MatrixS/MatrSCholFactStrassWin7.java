...
import com.mathpar.parallel.dap.multiply.MatrixS.MultiplyExtendedSWin;
...
public class MatrSCholFactStrassWin7 extends Drop {
    ...
    public MatrSCholFactStrassWin7() {
    ...
    public ArrayList<Drop> doAmin() {
        ...
        amin.add(new MatrSCholFactStrassWin7());
        amin.add(new MatrSMultStrassWin7());
        amin.get(1).key = 0;
        amin.add(new MultiplyExtendedSWin());
        amin.add(new MatrSCholFactStrassWin7());
        amin.add(new MatrSMultStrassWin7());
        amin.get(4).key = 0;
        amin.add(new MatrSMultStrassWin7());
