...
import com.mathpar.parallel.dap.multiply.MatrixD.MultiplyExtendedD4;

import java.util.ArrayList;

public class MatrDCholFact4 extends Drop {

    private final static MpiLogger LOGGER = MpiLogger.getLogger(MatrDCholFact4.class);
    ...
    public ArrayList<Drop> doAmin() {
        ...
        amin.add(new MatrDCholFact4());
        amin.add(new MatrDMult4());
        amin.get(1).key = 0;
        amin.add(new MultiplyExtendedD4());
        amin.add(new MatrDCholFact4());
        amin.add(new MatrDMult4());
        amin.get(4).key = 0;
        amin.add(new MatrDMult4());
