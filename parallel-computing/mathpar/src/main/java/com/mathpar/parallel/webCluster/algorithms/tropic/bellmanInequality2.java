...
/**
 *\BellmanInequalityPar(A,b); Ax+b<=x
 * @author serega
 */
...
b=[0,0,0,0];
\BellmanInequalityPar(A,b);

*/

public class bellmanInequality2 {
    public static void main(String args[])  throws Exception {
      ...
      /*  Ring ring = new Ring("R64MaxPlus[x]");
        ...
        if (MPI.COMM_WORLD.getRank() == 0) {   
            System.out.println("BellmanInequality2");
        ...
        MatrixS res=tropParallel.BellmanInequalityPar(A, B, ring, args, com);        
        if (MPI.COMM_WORLD.getRank() == 0){                       
            Object[] result = {res};
