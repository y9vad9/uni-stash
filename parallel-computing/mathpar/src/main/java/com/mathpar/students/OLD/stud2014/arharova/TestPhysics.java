...
public class TestPhysics {
    public static void main(String[] args) {
       ...
       Polynom p8 = new Polynom("1", ring);
        ...
        Polynom[][] pol2 = new SurfacePhysics().splines2D(b1, b2, x, y, temp1, ring); //создает кусочно-заданную функцию
        ...
        System.out.println("");
        Element m = new SurfacePhysics().generalMass(p8, c, pol2,pol, num8, ring);
        System.out.println("Общая масса= " + m);
        System.out.println("");
        Element[] gen = new SurfacePhysics().generalCentreObjectMass(p8, m, c, pol2,pol, num8, ring);
