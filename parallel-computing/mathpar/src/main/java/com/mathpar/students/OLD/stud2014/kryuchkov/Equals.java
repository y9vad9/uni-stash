...
public class Equals {
    ...
    public Element[] solve(Polynom p, Ring ring) {
        ...
        switch (powS) {
            case (3):
                res = solveEquals3(p, ring); // решение уравнения 3-й степени
                break;
            case (2):
    ...
    /**
     * solve2 дополняте неполное уравнение 1-ой степени до полного
     * @param (Polynom) p- степени = 1
     * @return (Polynom) p- вида ax+c
     */
    public Polynom solve1(Polynom p, Ring ring) {
     ...
     *
     */
    public Polynom solve2(Polynom p, Ring ring) {
     ...
     * @param (Polynom) степ2y^2)ени = 3
     * @return (Polynom) p вида ax^3+bx^2+cx+d
     */
    public Polynom solve3(Polynom p, Ring ring) {
        Polynom res = new Polynom();
    ...
    public static Element[] solveEquals2(Polynom p, Ring ring) {
        ...
        if (D.compareTo(NumberR64.ZERO, 1, ring)) {
    ...
    public static Element[] solveEquals3(Polynom p, Ring ring) {
        ...
        if (R2.compareTo(Q3, -2, ring)) { // если R^2 < Q^3  то....
    ...
    public static void main(String[] args) {
        ...
        Polynom p = new Polynom("(x-1)(x-2)(x-3)", ring);
        Polynom p1 = new Polynom("x^3y+y^2x^2+x+1",ring);
        Element[] q = new Equals().solve(p, ring);
