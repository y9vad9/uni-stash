...
/*
    Command to run:
    mpirun --hostfile /home/user/hostfile -np 4 java -cp /home/vladislav/dap/target/classes com/mathpar/students/KAU/Tolstikov/TestScatterv
*/
...
/*
    ...
    myrank = 0: q = [0, 1, 2, 3]
    myrank = 3: q = [12, 13, 14, 15]myrank = 1: q = [8, 9, 10, 11]
    myrank = 2: q = [4, 5, 6, 7]
 */
