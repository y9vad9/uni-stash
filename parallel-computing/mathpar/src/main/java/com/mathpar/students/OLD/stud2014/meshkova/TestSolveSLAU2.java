...
public class TestSolveSLAU2 {
    ...
    public static void main(String[] args) {
        ...
        aa[0][0] = new NumberR64(3);
        aa[0][1] = new NumberR64(4);
        aa[0][2] = new NumberR64(5);
        aa[1][0] = new NumberR64(4);
        aa[1][1] = new NumberR64(4);
        aa[1][2] = new NumberR64(1);
        aa[2][0] = new NumberR64(3);
        aa[2][1] = new NumberR64(5);
        aa[2][2] = new NumberR64(5);
        bb[0] = new NumberR64(2);
        bb[1] = new NumberR64(3);
