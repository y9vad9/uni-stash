...
/**
 *Данный класс реализует алгоритм нахождения массы тела и координат центра массы тела, ограниченного двумя сплайн-поверхностями
 * @author khvorov
 */
public class ObjectMassAndCentreObjectMass{
