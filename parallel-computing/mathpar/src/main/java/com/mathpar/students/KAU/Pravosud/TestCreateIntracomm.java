...
/*
    Command to run:
    mpirun  --hostfile hostfile  -np 7 java  -cp ./target/classes com/mathpar/students/KAU/Pravosud/TestCreateIntracomm
 */
...
/*
    ...
    myrank = 4: a = [30, 31, 32, 33, 34]myrank = 1: a = [0, 1, 2, 3, 4]myrank = 2: a = [0, 1, 2, 3, 4]
 */
