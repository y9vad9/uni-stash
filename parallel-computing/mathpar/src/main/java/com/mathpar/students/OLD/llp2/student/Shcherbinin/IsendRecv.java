...
public class IsendRecv {
    ...
    public IsendRecv(int row) throws MPIException {
        numb = 2;
...
//                System.out.println(Arrays.toString(a[i]));
    ...
    public IsendRecv(int row,int mult) throws MPIException {
        numb = mult;
        myrank =  MPI.COMM_WORLD.getRank();
        np =  MPI.COMM_WORLD.getSize();
        int[][] a = new int[row][np * numb];
...
private long testIsendRecv(int[][] a, int[][] b) throws MPIException {
