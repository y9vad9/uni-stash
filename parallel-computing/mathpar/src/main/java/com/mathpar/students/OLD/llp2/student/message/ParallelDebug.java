package com.mathpar.students.OLD.llp2.student.message;
import java.io.*;
import java.util.*;
    ...
    public void generateDebugLog_ex() throws MPIException, java.io.IOException {
        ...
        if (rank == 0) {
            for (int i = 1; i < size; i++) {
                ...
                //!!!! MPI.COMM_WORLD.Recv(message, 0, message.length, //!!!! MPI.CHAR, i, 50);
            ...
            //!!!! MPI.COMM_WORLD.Send(message, 0, message.length, //!!!! MPI.CHAR, 0, 50);
