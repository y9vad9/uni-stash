...
public class MathparTimeoutRunner {
    public MathparResult run(Page page, String task) {
    ...
    public MathparResult run(Page page, String task, int sectionId) {
        ...
        Future<MathparResult> future = executor.submit(new MathparCallable(page, task, sectionId));
        try {
        ...
        return new MathparResult("", ""); // Shouldn't come here.
    }
}
