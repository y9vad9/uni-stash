...
public class BitSieve {
     ...
     * be even.
     */
  public  BitSieve(NumberZ base, int searchLen) {
        /*
     ...
     */
  public  NumberZ retrieve(NumberZ initValue, int certainty) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    NumberZ candidate = initValue.add(
                                           NumberZ.valueOf(offset));
