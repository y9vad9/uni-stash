    ...
    public Element divideExact(NumberR divisor) {
        ...
        if (divisor.intVal.signum() == 0) {   // x/0
            ...
            if (this.signum() == -1) {
                ...
                return POSITIVE_INFINITY; // рассмотреть знак числителя
            }
        }
...
// Calculate preferred scale
    ...
    /**
     * Возведение в дробную степень со знаменателем 2
     *
     * @param n целое число
     * @param m =1 или 2
     *
