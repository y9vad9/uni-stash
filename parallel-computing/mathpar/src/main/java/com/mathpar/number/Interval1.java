 ...
 * @author
 */
  public class Interval1 extends Element {

      Element left;
      Element right;

      public Interval1(Element left1, Element right1) {
          left = left1;
          right = right1;
      }
...
//    IntList set;
//
//    public Interval1(){set=new IntList();}
//    public Interval1(IntList list){set=list;}
//    public Interval1(int[] arr){set=new IntList();  set.add(arr);}
...
//    }
//
//   public boolean equals(Interval1 i2) {
...
//    public Interval1 union(Interval1 i2) {
//          IntList a1 = set;
//          IntList a2 = i2.set;
...
//          return new Interval1(res);
//      }
//
//   // Пересечение
//    public Interval1 intersection(Interval1 i2) {
//          IntList a1 = set;
//          IntList a2 = i2.set;
//          IntList result = new IntList();
//          int i = 0;
...
//              }
//          }
//         return new Interval1(result);
//    }
//
// // Разность двух множеств
// public Interval1 subtraction(Interval1 i2) {
//          IntList a1 = set;
//          IntList a2 = i2.set;
//          a1 = junction(a1);
//          a2 = junction(a2);
...
//
//          if (a1.arr[i] > a2.arr[j]) {
//             if (result.arr[result.size - 1] != a2.arr[j] + 1) result.add(a2.arr[j] + 1);
//             System.arraycopy(a1.arr, i, result.arr, result.size, a1.size - i);
//             result.size = result.size + a1.size - i;
//          }
//          return new Interval1(result);
...
//        }
//         for (int k = 0; k < nchast; k++) RES[k]=new Interval1(res[k]);
//        return RES;
//    }
//
...
//   */
//   public Interval1[] divideOnPartsOf(int nchast, int[] arr) {
//          IntList procs = set;
//          IntList[] res = new IntList[nchast];
//          Interval1[] RES = new Interval1[nchast];
//          int i = 0;
...
//            if (i!=0)res.append(", ");else res.append("{");
//
...
//          res.append("}  Всего элементов: " + '\u221e');
//       else
//          res.append("}  Всего элементов: " + (new Interval1(a)).cardinalNumber());
//       return res.toString();
//        }
//    }
//
